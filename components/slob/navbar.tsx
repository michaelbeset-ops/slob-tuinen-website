  ...
  return (
    <header className="absolute inset-x-0 top-0 z-50">
      <nav className="mx-auto flex max-w-[1600px] items-center justify-between px-6 py-6 md:px-12 md:py-8">
        <a href="#top" className="shrink-0" aria-label="Slob Tuinen, naar home">
          <img
        ...
        <div className="fixed inset-0 z-[60] flex flex-col bg-foreground lg:hidden">
          ...
          <nav className="flex flex-1 flex-col px-6 pt-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-8 flex items-center justify-center gap-2 rounded-none bg-forest px-5 py-4 text-sm font-bold uppercase tracking-wide text-white"
            >
              <WhatsAppIcon className="size-4" />
              WhatsApp Martin
            </a>
